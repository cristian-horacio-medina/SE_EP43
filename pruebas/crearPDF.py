...
if __name__ == "__main__":
    ...
    materias_por_año = [
    {
        "año": 2024,
        "materias": [
            {"nombre": "Matemáticas", "division": "A", "turno": "Mañana", "dia": "Lunes", "horario": "08:00-10:00"},
            {"nombre": "Historia", "division": "B", "turno": "Tarde", "dia": "Martes", "horario": "14:00-16:00"}
        ]
    }
                        ]    
    ...
    crea_pdf(materias_por_año)  # Llama a tu función con la información completa
